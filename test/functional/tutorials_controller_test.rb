...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { description: @tutorial.description, difficulty: @tutorial.difficulty, num_ratings: @tutorial.num_ratings, rating: @tutorial.rating, title: @tutorial.title, user_id: @tutorial.user_id }
    end
  ...
  test "should update tutorial" do
    put :update, id: @tutorial, tutorial: { description: @tutorial.description, difficulty: @tutorial.difficulty, num_ratings: @tutorial.num_ratings, rating: @tutorial.rating, title: @tutorial.title, user_id: @tutorial.user_id }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
