...
/* memory initializer */ allocate([72,101,108,108,111,44,32,119,111,114,108,100,33,10,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE)
...
function _main($argc, $argv) {
  ...
  $2=$argc;
  $3=$argv;
  var $4=_printf(((8)|0), (tempInt=STACKTOP,STACKTOP = (STACKTOP + 1)|0,STACKTOP = ((((STACKTOP)+7)>>3)<<3),assert((STACKTOP|0) < (STACK_MAX|0)),SAFE_HEAP_STORE(tempInt, 0, "i32", 0),tempInt));
